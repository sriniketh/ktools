...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            plugin("aboutlibraries", "com.mikepenz.aboutlibraries.plugin").version("12.1.0-exp01")
            plugin("buildconfig", "com.github.gmazzo.buildconfig").version("5.6.2")
            ...
            library("ktor-client", "io.ktor", "ktor-client-core").version("3.1.2")
        }
    }
}
